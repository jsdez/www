...
import iconDark from '@/media/icon-dark.png';
import iconLight from '@/media/icon-light.png';
  ...
  return (
    <>
      ...
      >
        <div
          className={twMerge(
            `mx-auto mt-4 flex h-[80px] w-full max-w-full rounded-base
        items-center justify-between px-6 transition-transform
        duration-300 ease-in-out bg-teal-300 dark:bg-darkBg transform `,
    ...
    <div className="flex flex-col space-y-3">
      {links.map((link) => (
        <a
          ...
          target={link.href.startsWith('http') ? '_blank' : '_self'}
          rel={link.href.startsWith('http') ? 'noopener noreferrer' : undefined}
          className="p-2 text-center text-lg font-bold bg-teal-300 dark:bg-darkBg

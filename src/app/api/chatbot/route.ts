...
5. If question is unrelated to Neo's professional profile, politely redirect
...
function findRelevantSuggestions(
  ...
  return [
    "What is Neo's current role and company?",
    'What notable projects has he worked on?',
    'How can I contact Neo?',
  ];
}
...
async function getFallbackResponse(
  ...
  if (
    ...
    return {
      response:
        "Hello! 👋 I'm Neo's AI assistant, here to help you learn about his work in geospatial development and software engineering. Feel free to ask about his projects, skills, experience at Camptocamp, or anything else related to his professional background!",
      suggestions: [
        "What is Neo's current role and company?",
  ...
  if (
    ...
    return {
      response:
        'I can help you learn about Jake Dennison! Ask me about: 🗺️ His geospatial expertise (QGIS, OpenLayers, GIS) 💻 Programming skills (Python, JavaScript, TypeScript) 🏢 Current role at Camptocamp 🚀 Projects like Digipin, QGIS Hub Plugin 🎓 Education and career journey 📧 How to get in touch. What interests you most?',
      suggestions: [
        'Who is Jake Dennison?',
  ...
  return {
    response:
      "I'm here to share information about Jake Dennison's professional background! You can ask me about his work at Camptocamp, his expertise in geospatial technologies, specific projects he's worked on, his education, or how to contact him. What would you like to know? 🤔",
    suggestions: [
      'Who is Jake Dennison?',
      "What is Neo's current role and company?",
      'What technologies does he work with?',

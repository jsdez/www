      ...
      {links.map((link) => (
        <li key={link.href}>
          <a
            ...
            className="text-text border-4 border-transparent hover:border-border hover:bg-teal-300
...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-bg p-8 border-t-8 border-border dark:border-darkBorder dark:bg-darkBg">
      <div className="max-w-full mx-auto px-5">
        ...
        {/* Bottom Section */}
        <div className="border-t-4 border-border dark:border-darkBorder pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-text font-bold text-lg dark:text-darkText">
            © {currentYear} NeoAutomate Limited | All rights reserved.
          </p>
        </div>
      </div>
    </footer>
